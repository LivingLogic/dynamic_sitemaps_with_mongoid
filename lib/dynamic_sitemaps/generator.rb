module DynamicSitemaps
  class Generator
    ...
    def sitemap_for(collection, options = {}, &block)
      raise ArgumentError, "The collection given to `sitemap_for` must respond to #each. This is for performance. Use `Model.scoped` to get an ActiveRecord relation that responds to #each." unless collection.respond_to?(:each)
