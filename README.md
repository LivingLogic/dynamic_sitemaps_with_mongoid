...
The argument passed to `sitemap_for` needs to respond to [`#each`](http://api.rubyonrails.org/classes/ActiveRecord/Batches.html#method-i-each), like an ActiveRecord [Relation](http://api.rubyonrails.org/classes/ActiveRecord/Relation.html).
